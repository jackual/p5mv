...
export async function captureFrames(region) {
    ...
    if (sketches.find(s => s.id === region.sceneId).brush) {
        ...
        // head = []
        // brushlibs = '<script src="https://cdn.jsdelivr.net/npm/p5@1.11.10/lib/p5.js"></script> <script src="https://cdn.jsdelivr.net/npm/p5.brush"></script>'
    ...
    head = brushlibs + head.map(i => script(i)).join('\n')
