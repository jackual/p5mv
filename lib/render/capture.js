...
import { broadcastProgress } from '@/app/api/render/progress/route.js';
...
<body>
  ...
  ${script([projectRoot, 'public', 'sketches', region.sceneId || 'matrix', 'sketch.js'])}
    ...
    const outDir = region.project.render.outputFolder || path.join(projectRoot, 'output', region.code);
