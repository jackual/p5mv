    ...
    return {
        ...
        handleEditDelete: () => {
            if (isTextInputFocused()) {
                ...
                // Dispatch custom event for Scenes component to handle delete
                window.dispatchEvent(new CustomEvent('menu-delete-scene'));
            }
        },
        ...
        handleTimelineSetSnap: (event, snapValue) => {
            if (page === 'timeline') {
                project.snap = snapValue;
            }
        },
